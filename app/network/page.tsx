          ...
          {NETWORKS.map((network, idx) => (
            ...
            >
              <motion.div
                ...
                whileHover={{
                  scale: 1.04,
                  boxShadow: `0 20px 50px ${THEME}33`,
                  borderColor: `${THEME}88`,
                }}
              >
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  style={{
                    background: `radial-gradient(circle at center, ${THEME}15, transparent 70%)`,
                  }}
                />
                ...
                <div className="relative z-10 w-[120px] h-[60px] flex items-center justify-center">
                  {logos[network.slug] ? (
                    ...
                    <span
                      ...
                      style={{ color: THEME, fontFamily: "Space Grotesk, sans-serif" }}
                    >
                      {network.name}
                    </span>
                  )}
